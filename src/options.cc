...
void PrintUsage() {
  std::cout << "Usage: gitstatusd [OPTION]...\n"
            ...
            << "    22. The number of staged modified files.\n"
            << "    23. The push remote name, e.g. \"upstream\" or \"origin\".\n"
            << "    24. Push remote URL. Can be empty.\n"
            << "    25. Number of commits the current branch is ahead of push remote.\n"
            << "    26. Number of commits the current branch is behind push remote.\n"
            << "    27. Number of files in the index with skip-worktree bit set.\n"
            << "    28. Number of files in the index with assume-unchanged bit set.\n"
            << "    29. Encoding of the HEAD's commit message. Empty value means UTF-8.\n"
            << "    30. The first paragraph of the HEAD's commit message as one line.\n"
            << "\n"
